...
// //   html2canvas(configRef.current, { scale: 0.7 }).then(async (canvas) => {
// //     let quality = 0.3;
// //     let screenshot = canvas.toDataURL("image/jpeg", quality);
...
// //       if (!imageUrl) {
// //         alert("❌ Failed to get public URL for screenshot.");
// //         return;
// //       }
    ...
    <>
      ...
      {window.innerWidth < 1024 ? (
        ...
        <div className="flex flex-col w-full gap-4 items-center 3xl:pt-2">
          ...
          <div className="flex gap-4 items-center w-full 3xl:pt-2">
          <button className="px-1 cursor-pointer flex gap-2 w-1/2 justify-center items-center text-[16px] border border-gray-400 py-2 rounded-md ">
  <img src="/Online Store.png" className="w-6 h-6" alt="store" />
  Store near you
</button>

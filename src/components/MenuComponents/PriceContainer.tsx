    ...
    <>
      ...
      <div className="hidden lg:flex flex-col lg:flex-row gap-4 items-center">
        ...
        <div className="flex w-2/3 gap-2">
          <button className="w-1/2 border border-black rounded-md whitespace-nowrap p-2 text-[14px]">Save</button>
          <button className="w-1/2 bg-black rounded-md text-white whitespace-nowrap p-2 text-[14px]">Add To Cart</button>
        </div>
      </div>
    </>
  )
